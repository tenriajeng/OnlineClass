...
class KelasTable extends React.Component {
    ...
    updateKelas = () => {
        ...
        Axios.put(
            `http://localhost:6600/admin/kelas/${this.state.id}`,
            data
        ).then((res) => {
    ...
    getOnedata(id) {
        ...
        try {
            Axios.get(`http://localhost:6600/admin/kelas/detail/${id}`).then(
                (res) => {
